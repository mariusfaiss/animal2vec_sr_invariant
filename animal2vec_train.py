...
config_path = os.path.join(os.path.curdir, "configs/local/samplerate/audio")

# pretrain
# config_name = "samplerate_data2vec_base_pretrain_10s-2-1_5_sinc_38ms_mixup_pswish"
# config_name = "TE_pretrain_small_temporal_mix_samplerate.yaml"
# config_name = "TE_pretrain_medium_temporal_mix_samplerate.yaml"

# finetune
# config_name = "samplerate_finetune_mixup_100_test"
# config_name = "TE_finetune_small_temporal_mix_samplerate.yaml"
